...
COUNTRIES = {
    ...
    "GBR": ["UK_BANK_RATE", "UK_GILT_10Y", "GBR_CPI_INFLATION", "GBR_GDP_REAL"],
    "DEU": ["DE_BUND10", "DEU_CPI_INFLATION", "DEU_GDP_REAL"],
    "FRA": ["FRA_CPI_INFLATION", "FRA_GDP_REAL"],
    "JPN": ["JPN_CPI_INFLATION", "JPN_GDP_REAL"],
}
